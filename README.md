...
* It introduces a cointegration test algorithm selecting the appropriate asset pairs (the data is downloaded with asyncio)
* The cointegration vector of the Johansen test helps to find a suitable hedge ratio for a linear mean reversion strategy (the cointegration tests are executed in a multiprocessed way)
