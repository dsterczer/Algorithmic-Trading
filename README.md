...
* Firstly, it introduces a cointegration test algorithm selecting the appropriate asset pairs
* Throughout a linear mean reversion strategy we can see how the cointegration vector of the Johansen test helps to find a suitable hedge ratio
