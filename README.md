...
* The cointegration vector of the Johansen test helps to find a suitable hedge ratio for a linear mean reversion strategy (multiprocessed execution of the cointegration tests completes it a quarter of the time earlier)
